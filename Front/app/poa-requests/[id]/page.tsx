                      ...
                      <div key={doc.id} className="relative group cursor-pointer">
                        <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg overflow-hidden">
                          ...
                          <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all flex items-center justify-center">
                            <p className="text-white opacity-0 group-hover:opacity-100 font-medium text-sm text-center px-2">
                              {doc.filename}
                            </p>
                          </div>
                        </div>
                    ...
                    {request.workflow.map((step, index) => (
                      <div key={index} className="flex gap-4">
                        ...
                        <div className="flex-1 pb-8">
                          ...
                          {step.agent && (
                            <p className="text-xs text-blue-600 mt-2">Agent: {step.agent}</p>
                          )}
                        </div>
                      </div>
                    ))}
